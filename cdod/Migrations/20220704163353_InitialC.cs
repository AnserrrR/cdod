        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProgramFileUrl = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CoursePrice = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    EquipmentPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    passportNo = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    passportIssue = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    passportDate = table.Column<DateOnly>(type: "date", nullable: false),
                    passportCode = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<int>(type: "int", nullable: false),
                    SecondPhoneNumber = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncementDTOCourseDTO", x => new { x.AnnouncementsId, x.CoursesId });
                    table.ForeignKey(
                        name: "FK_AnnouncementDTOCourseDTO_Announcements_AnnouncementsId",
                        column: x => x.AnnouncementsId,
                        principalTable: "Announcements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnnouncementDTOCourseDTO_Courses_CoursesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Patronymic = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Descriotion = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseDTOTeacherDTO", x => new { x.CoursesId, x.TeachersUserId });
                    table.ForeignKey(
                        name: "FK_CourseDTOTeacherDTO_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseDTOTeacherDTO_Teachers_TeachersUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckURL = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    SignYear = table.Column<int>(type: "int", nullable: false),
                    ContractStateId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentToCourses", x => new { x.StudentId, x.CourseId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncementDTOGroupDTO", x => new { x.AnnouncementsId, x.GroupsId });
                    table.ForeignKey(
                        name: "FK_AnnouncementDTOGroupDTO_Announcements_AnnouncementsId",
                        column: x => x.AnnouncementsId,
                        principalTable: "Announcements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnnouncementDTOGroupDTO_Groups_GroupsId",
                        column: x => x.GroupsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupDTOStudentDTO", x => new { x.GroupsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_GroupDTOStudentDTO_Groups_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupDTOStudentDTO_Students_StudentsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentToLessons", x => new { x.StudentId, x.LessonId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeacherId = table.Column<int>(type: "int", nullable: false),
                    LessonId = table.Column<int>(type: "int", nullable: false),
                    WorkTime = table.Column<TimeOnly>(type: "time(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherToLessons", x => new { x.TeacherId, x.LessonId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementDTOCourseDTO_CoursesId",
                table: "AnnouncementDTOCourseDTO",
                column: "CoursesId");

            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementDTOGroupDTO_GroupsId",
                table: "AnnouncementDTOGroupDTO",
                column: "GroupsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseDTOTeacherDTO_TeachersUserId",
                table: "CourseDTOTeacherDTO",
                column: "TeachersUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupDTOStudentDTO_StudentsId",
                table: "GroupDTOStudentDTO",
                column: "StudentsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentToCourses_CourseId",
                table: "StudentToCourses",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentToLessons_LessonId",
